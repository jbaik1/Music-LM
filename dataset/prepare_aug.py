"""
Download the Maestro dataset here: https://magenta.tensorflow.org/datasets/maestro#v300
(The midi-zip file, not the 120GB one)
"""
...
hf_token ="TOKEN" # Use yours if you want to replicate it
...
tokenizer.push_to_hub("HF_USERNAME/REPOISTORY", private=True, token=hf_token)
